...
last_upstream_response_time = 0.0
...
def job():
    ...
    global last_upstream_response_time
    ...
    while True:
        if p.poll(1):
            ...
            last_upstream_response_time = float(tokens[4])
...
def get_metrics():
    ...
    response += f"last_upstream_response_time {last_upstream_response_time}\n"
